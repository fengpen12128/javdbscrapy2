...
class JavdbscrapySpiderMiddleware:
...
class JavdbscrapyDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class ScrapeOPsFakeUserAgentMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.endpoint = settings.get('USER_AGENT_ENDPOINT')
        self.fake_user_agents_active = settings.get('USER_AGENT_ENABLE')
    ...
    def _get_user_agent_list(self):
        ...
        self.user_agents_list = json_res.get('result', [])
